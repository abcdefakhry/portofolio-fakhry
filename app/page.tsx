...
// --- 1. DATA ---
const projects = [
  { id: 1, title: "Portofolio", category: "WEB DEVELOPMENT", description: "Website portofolio pribadi interaktif dan responsif yang dibangun menggunakan Next.js, Framer Motion, dan Tailwind CSS.", image: "/portofolio2.jpg", link: "https://github.com/abcdefakhry", github: "https://github.com/abcdefakhry" },
  ...
  { id: 4, title: "Web Selempang UMKM", category: "WEB DEVELOPMENT", description: "Website katalog dan kustomisasi selempang wisuda premium untuk usaha mikro (UMKM) Dins Selempang.", image: "/web-selempang-umkm.jpg", link: "https://github.com/abcdefakhry", github: "https://github.com/abcdefakhry" },
];
    ...
    >
      ...
      >
        ...
        <div className="flex justify-center gap-6">
            ...
            <a href="https://www.instagram.com/fakhryzp_?igsh=MWN6NHdrbzZkbXBnag%3D%3D&utm_source=qr" target="_blank" className="p-4 border border-gray-800 rounded-full hover:bg-white hover:text-black transition-all">
